...
詳細仕様は [docs/spec.md](/Users/cmt1910/projects/ha-gothick/docs/spec.md) を参照してください。
...
設定値は [config/config.yaml](/Users/cmt1910/projects/ha-gothick/config/config.yaml) で管理します。
...
合成フォントの配布ライセンスは SIL Open Font License 1.1 を想定しています。上流フォントの権利情報は [LICENSE](/Users/cmt1910/projects/ha-gothick/LICENSE) を参照してください。
